...
// ImageLib Utility Toolkit's OpenGL Functions
	...
	ILAPI GLuint	ILAPIENTRY ilutGLBindMipmaps();
	ILAPI ILboolean	ILAPIENTRY ilutGLBuildMipmaps();
	ILAPI GLuint	ILAPIENTRY ilutGLLoadImage(const ILstring FileName);
	ILAPI ILboolean	ILAPIENTRY ilutGLScreen();
	ILAPI ILboolean	ILAPIENTRY ilutGLScreenie();
...
#ifdef  ILUT_USE_BEOS
	ILAPI BBitmap ILAPIENTRY ilutConvertToBBitmap();
#endif//ILUT_USE_BEOS
...
// ImageLib Utility Toolkit's Win32 GDI Functions
		...
		ILAPI HPALETTE	ILAPIENTRY ilutGetHPal();
		ILAPI ILubyte*	ILAPIENTRY ilutGetPaddedData();
		ILAPI ILboolean	ILAPIENTRY ilutGetWinClipboard();
		...
		ILAPI ILboolean	ILAPIENTRY ilutSetWinClipboard();
